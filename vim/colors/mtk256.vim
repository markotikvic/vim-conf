...
hi Directory	ctermfg=15	ctermbg=0	cterm=NONE
hi Error	ctermfg=15	ctermbg=9	cterm=NONE
hi Identifier	ctermfg=46	ctermbg=0	cterm=NONE
hi Function	ctermfg=15	ctermbg=0	cterm=NONE
hi LineNr	ctermfg=15	ctermbg=0	cterm=NONE
hi MatchParen	ctermfg=15	ctermbg=4	cterm=NONE
hi NonText	ctermfg=15	ctermbg=0	cterm=NONE
hi Normal	ctermfg=15	ctermbg=0	cterm=NONE
hi PreProc	ctermfg=207	ctermbg=0	cterm=NONE
...
hi String	ctermfg=208	ctermbg=0	cterm=NONE
hi TabFillLine	ctermfg=15	ctermbg=0	cterm=NONE
